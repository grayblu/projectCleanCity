          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">누적<br>회원수</strong><span>Last 7 days</span>
                  <div class="count-number">${UserSummary}</div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">설치 쓰레기통</strong><span>Last 5 days</span>
                  <div class="count-number">${CountBin}</div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
